...
class ZWLoginViewController: UIViewController, UIScrollViewDelegate {
    ...
    let textColor: UIColor = UIColor.colorWith(50, 50, 50, alpha: 1)
    ...
    func setupTextField() {
        ...
        addTextFieldToTopViewWith(phoneTextField, frame: CGRectMake(leftMargin, 1, AppWidth - leftMargin, textH - 1), placeholder: "请输入手机号")
        ...
        addTextFieldToTopViewWith(psdTextField, frame:  CGRectMake(leftMargin, textH + 1, AppWidth - leftMargin, textH - 1), placeholder: "密码")
    }
    ...
    func addTextFieldToTopViewWith(textField: UITextField, frame: CGRect, placeholder: String) {
